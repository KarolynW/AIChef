...
export default class DataSheet_user extends DataSheetBase {
  ...
  makeDefaultItems() {
    ...
    item['email'] = "contact@theaichef.co.uk";
    item['id'] = "1";
    item['password'] = "4fff19c134825050.37fd409b1a92395a20a3379a89cb70ff0e4e9e73900cb1f8b4af990bf5906189";
    item['name'] = "test";
    item['created_at'] = "1628498557033";
    item.key = key++;
  }
